...
const server2 = new ServerConfiguration<{}>('https://ppt-atfehr-staging.herokuapp.com', {}, 'staging');
const server3 = new ServerConfiguration<{}>('https://ppt-atfehr-prod.herokuapp.com', {}, 'production');
